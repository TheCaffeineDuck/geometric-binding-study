"""
studies/01_run_setA.py
======================
Phase 1 - Set A only: phi0=0.3, R=3.0
...
OUT_FILE = os.path.join(OUTPUT_DIR, "set_A_baseline.json")

print("=" * 60)
print("  Phase 1 - Set A: phi0=0.3, R=3.0")
...
for step in range(N_STEPS + 1):
    ...
    if step % PRINT_EVERY == 0 and step > 0:
        ...
        print("  [A] t=%7.1f  E=%.5f  max|phi|=%.5f  drift=%.2e  [%.1f%%  ETA %.1f min]" % (
